...
endoflastmon: pd.Timestamp = pd.Timestamp(tday - datetime.timedelta(days=tday.day))
startoflastmon: pd.Timestamp = pd.Timestamp(endoflastmon - datetime.timedelta(days=endoflastmon.day - 1))
